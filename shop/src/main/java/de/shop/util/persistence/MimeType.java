...
public enum MimeType {
	JPEG("image/jpeg"), PJPEG("image/pjpeg"), PNG("image/png"), MP4("video/mp4"), WAV(
			"audio/wav");
	...
	public String getExtension() {
		...
		case MP4:
			return "mp4";
		default:
			throw new IllegalStateException("Der MIME-Type " + this
	...
	public static MimeType buildFromExtension(String extension) {
		...
		case "mp4":
			return MP4;
		default:
			throw new IllegalStateException("Die Extension " + extension
					+ " wird nicht unterstuetzt");
		}
	}
	...
	public MultimediaType getMultimediaType() {
		...
		throw new IllegalStateException("Der MultimediaType " + this
				+ " wird nicht unterstuetzt");
	}
