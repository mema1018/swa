...
public class BestellungResource {
	...
	// public Collection<Lieferung>
	// findLieferungenByBestellungId(@PathParam("id") Long id) {
	...
	// "findLieferungenByBestellungId: NOT YET IMPLEMENTED";
	...
	public Response updateBestellung(@Valid Bestellung bestellung) {
		...
		final Bestellung orginalBestellung = bs.findBestellungById(bestellung
				.getId());
		if (orginalBestellung == null) {

			final String msg = "Keine Bestellung gefunden mit der ID "
					+ bestellung.getId();
