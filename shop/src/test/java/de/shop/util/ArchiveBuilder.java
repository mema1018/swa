...
public enum ArchiveBuilder {
	...
	private final WebArchive archive = ShrinkWrap.create(WebArchive.class,
			TEST_WAR);
	private final WebArchive archiveMitTestklassen = ShrinkWrap.create(
			WebArchive.class, TEST_WAR);
	...
	private void addJars() {
		...
		final PomEquippedResolveStage pomResolver = Maven.resolver().offline()
